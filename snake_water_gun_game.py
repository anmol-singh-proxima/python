...
* So, in this program, program will randomly select any of the three things
* And it will ask the suer to enter its choice
* Then, it will check who won, and based on that it will create a score board
* There are total of 10 chances for the user
